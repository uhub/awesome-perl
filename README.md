...
* [trizen/youtube-viewer](https://github.com/trizen/youtube-viewer) - Lightweight application for searching and playing videos from YouTube.
...
* [GouveaHeitor/spellbook](https://github.com/GouveaHeitor/spellbook) - Micro-framework for rapid development of reusable security tools
...
* [trizen/straw-viewer](https://github.com/trizen/straw-viewer) - Application for searching and playing videos from YouTube, using the API of invidio.us
...
* [vmware/vsphere-automation-sdk-perl](https://github.com/vmware/vsphere-automation-sdk-perl) - Perl samples, language bindings, and API reference documentation for vSphere using the VMware REST API
