...
* [manwar/perlweeklychallenge-club](https://github.com/manwar/perlweeklychallenge-club) - Knowledge base for The Weekly Challenge Club members. Supported languages are Perl, Raku, Ada, APL, Awk, Bash, Bc, Befunge, BQN, Brainfuck, C, C++, C#, Clojure, Elm, Erlang, Fish, Forth, Fortran, Gembase, GNAT, Go, Haskell, Haxe, HTML, Idris, Janet, Java, JavaScript, Kotlin, Lisp, Lua, Mumps, Nim, Node, OCaml, Ook, Pascal, PHP, Python, Postscript, Prolog, R, Ruby, Rust, Scala, Smalltalk, SQL, Swift and Tcl.
...
* [denny/ShinyCMS](https://github.com/denny/ShinyCMS) - ShinyCMS is an open source CMS. This version is built with Perl and Catalyst. (Ruby on Rails version: https://github.com/denny/ShinyCMS-ruby)
...
* [htrgouvea/spellbook](https://github.com/htrgouvea/spellbook) - Micro-framework for rapid development of reusable security tools
...
* [manwar/design-patterns](https://github.com/manwar/design-patterns) - Design Patterns using Modern Perl.
