...
* [manwar/perlweeklychallenge-club](https://github.com/manwar/perlweeklychallenge-club) - Knowledge base for The Weekly Challenge Club members. Supported languages are Perl, Raku, APL, Awk, Bash, Bc, C, C++, C#, Clojure, Elm, Erlang, Fish, Forth, Fortran, Gembase, GNAT, Go, Haskell, HTML, Idris, Janet, Java, JavaScript, Kotlin, Lisp, Lua, Mumps, Node, OCaml, Ook, Pascal, PHP, Python, Postscript, Prolog, R, Ruby, Rust, Scala, SQL, Swift and Tcl.
...
* [denny/ShinyCMS](https://github.com/denny/ShinyCMS) - ShinyCMS is an open source CMS built in Perl using the Catalyst framework. (Also available in refreshing new Ruby flavour! github.com/denny/ShinyCMS-ruby)
