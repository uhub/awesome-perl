...
* [josy-cruz/perl-m8f](https://github.com/josy-cruz/perl-m8f) - Perl hello world example. Docs could be enhanced for better presentation.
...
* [josy-cruz/perl-zuw](https://github.com/josy-cruz/perl-zuw) - Perl hello world example. Docs could be enhanced for better presentation.
* [josy-cruz/perl-xcx](https://github.com/josy-cruz/perl-xcx) - Perl hello world example. Docs could be enhanced for better presentation.
* [josy-cruz/perl-q2q](https://github.com/josy-cruz/perl-q2q) - Perl hello world example. Docs could be enhanced for better presentation.
* [josy-cruz/perl-o5x](https://github.com/josy-cruz/perl-o5x) - Perl hello world example. Docs could be enhanced for better presentation.
* [josy-cruz/perl-met](https://github.com/josy-cruz/perl-met) - Perl hello world example. Docs could be enhanced for better presentation.
* [josy-cruz/perl-h9m](https://github.com/josy-cruz/perl-h9m) - Perl hello world example. Docs could be enhanced for better presentation.
* [josy-cruz/perl-7i8](https://github.com/josy-cruz/perl-7i8) - Perl hello world example. Docs could be enhanced for better presentation.
* [josy-cruz/perl-7bp](https://github.com/josy-cruz/perl-7bp) - Perl hello world example. Docs could be enhanced for better presentation.
...
* [genelet/mlm](https://github.com/genelet/mlm) - Comprehensive open-source Multi-Level Marketing (MLM) Software
...
* [sarahkadar/pflogsumm](https://github.com/sarahkadar/pflogsumm) - NOT MAINTAINED
...
* [manwar/perl-cool-snippets](https://github.com/manwar/perl-cool-snippets) - Collection of Perl cool snippets.
...
* [Tekki/sql-ledger](https://github.com/Tekki/sql-ledger) - :books: The most advanced SQL-Ledger version.
...
* [robinbowes/net-udap](https://github.com/robinbowes/net-udap) - Net::UDAP is a Perl module to configure the Logitech SqueezeBox Receiver (SBR) from a PC, i.e. without requiring a SqueezeBox Controller (SBC)
...
* [vti/cpan-audit-deprecated](https://github.com/vti/cpan-audit-deprecated) - Check CPAN modules for known security vulnerabilities
...
* [ho-tex/pdfcrop](https://github.com/ho-tex/pdfcrop) - pdfcrop perl utility
...
* [vmware-archive/vsphere-automation-sdk-perl](https://github.com/vmware-archive/vsphere-automation-sdk-perl) - [DEPRECATED] Please see README. Perl samples, language bindings, and API reference documentation for vSphere using the VMware REST API
...
* [mbeijen/File-MimeInfo](https://github.com/mbeijen/File-MimeInfo) - Perl module for determining file types using the freedesktop.org shared mime-info database
...
* [klein0r/fhem-tasmota](https://github.com/klein0r/fhem-tasmota) - DEPRECATED - PLEASE USE MQTT2_DEVICE INSTEAD
...
* [fasheng/vimwiki2org](https://github.com/fasheng/vimwiki2org) - Convert VimWiki files to Emacs Org-Mode
...
* [azizz98/vMass](https://github.com/azizz98/vMass) - vMass Bot :hook: Vulnerability Scanner & Auto Exploiter Tool Written in Perl.
* [rocky/Perl-Devel-Trepan](https://github.com/rocky/Perl-Devel-Trepan) - Perl port of trepanning debugger
* [ahloiscreamo/NewJeans](https://github.com/ahloiscreamo/NewJeans) - Dotfile for Dec 2022 | I3WM | Rosé Pine colorscheme
* [Izder456/dotfiles](https://github.com/Izder456/dotfiles) - My OpenBSD Dotfiles
* [sgnix/kelp](https://github.com/sgnix/kelp) - A web framework light, yet rich in nutrients.
* [metacpan/metacpan-client](https://github.com/metacpan/metacpan-client) - Home of the official MetaCPAN Perl API client.
...
* [PrefKarafuto/New_0ch_Plus](https://github.com/PrefKarafuto/New_0ch_Plus) - 開発が停止した2ch/5chライク電子掲示板スクリプト「ぜろちゃんねるプラス」の再開発を目的としたプロジェクト
* [pjf/autodie](https://github.com/pjf/autodie) - Make functions succeed or die in Perl, with lexical scope.
* [Ovid/Cor](https://github.com/Ovid/Cor) - Corinna - Bring Modern OO to the Core of Perl
* [jonasbn/perl-workflow](https://github.com/jonasbn/perl-workflow) - Workflow - simple, flexible system to implement workflows/state machines
...
* [jwilk/perl-friday](https://github.com/jwilk/perl-friday) - Perl code that is syntactically correct only on Fridays
* [ARON-TN/Mega-Bot](https://github.com/ARON-TN/Mega-Bot) - [NEW] : Mega Bot ☣ Scanner & Auto Exploiter
...
* [htrgouvea/uranus](https://github.com/htrgouvea/uranus) - [W.I.P] An ecosystem of crawlers for detecting: leaks, sensitive data exposure and attempts exfiltration of data
...
* [aron-tn/Mega-Bot](https://github.com/aron-tn/Mega-Bot) - [NEW] : Mega Bot ☣ Scanner & Auto Exploiter
* [manwar/design-patterns](https://github.com/manwar/design-patterns) - Design Pattern using Modern Perl.
